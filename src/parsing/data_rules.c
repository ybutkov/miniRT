...
/*   Updated: 2026/01/24 18:05:34 by ybutkov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_data_rule	*get_data_rules(void)
{
	...
	if (!init)
	{
		...
		data_rules[3] = (t_data_rule){"L", {VEC3, FLOAT, COLOR}, 3, 3, create_l};
		...
		data_rules[7] = (t_data_rule){"tr", {VEC3, VEC3, VEC3, COLOR, FLOAT},
			5, 4, create_tr};
		data_rules[8] = (t_data_rule){"box", {VEC3, VEC3, VEC3, COLOR, FLOAT},
			5, 4, create_b};
		init = 1;
	}
	return (data_rules);
